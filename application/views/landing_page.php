   ...
   <body>
      ...
      <div class="Header" id="Home">
         <nav class="navbar fixed-top">
            <div class="container">
               <a class="navbar-brand" href="#">Traditional Ventures</a>
               ...
               <div class="row Section">
                  <div class="col">
                     <div class="box">
                        ...
                        <p>Selamat datang di aplikasi Sistem Informasi Penggajian Karyawan <br>Traditional ventures</p>
                     </div>
                  </div>
                  <div class="col headerImg" style="background-image: url('<?php echo base_url()?>assets/img/payrol.png');"></div>
         ...
         <div class="Section">
            <div class="text-center">
               ...
               <div class="subHeading">
                  Berikut informasi lebih lengkap tentang website <br>informasi penggajian karyawan Traditional Ventures</div>
            </div>
                  ...
                  <div class="team-memeber col-md-6 col-lg-4 col-xl-3">
                     <div class="card">
                        ...
                        <div class="TeamInfo text-center">
                           ...
                           <div class="Job">Traditional Ventures</div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-12 text-center my-3">
                  Copyright &copy; Rojacky | Penggajian 2023 - Traditional Ventures
               </div>
            </div>
         </div>
      </div>
